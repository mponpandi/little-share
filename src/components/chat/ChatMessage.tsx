...
import { Check, CheckCheck, MapPin, Navigation, Image as ImageIcon } from "lucide-react";
        ...
        case "image":
          return (
            <div className="relative">
              ...
              />
              {content && (
                <p className="text-sm mt-2 opacity-90">{content}</p>
              )}
            </div>
          );
        ...
        case "live_location":
          return (
            <button
              ...
              className="flex items-center gap-3 p-3 rounded-lg bg-white/10 hover:bg-white/20 transition-colors w-full text-left min-w-[200px]"
            >
              <div
